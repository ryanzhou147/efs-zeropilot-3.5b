...
void initDrivers()
{
    ...
    leftFlapMotorHandle = new MotorControl(&htim3, TIM_CHANNEL_3, 5, 10);
    rightFlapMotorHandle = new MotorControl(&htim1, TIM_CHANNEL_1, 5, 10);
    steeringMotorHandle = new MotorControl(&htim1, TIM_CHANNEL_2, 5, 10);
